 ...
 */
class InternetStackHelper : public PcapHelperForIpv4, public PcapHelperForIpv6, public PcapHelperForRadeep
                            public AsciiTraceHelperForIpv4, public AsciiTraceHelperForIpv6, public AsciiTraceHelperForRadeep
{
public:
  /**
  ...
  void SetRoutingHelper (const RadeepRoutingHelper &routing);
  ...
  void SetRadeepStackInstall (bool enable);
  ...
  void SetRadeepArpJitter (bool enable);
  /**
...
private:
  ...
  virtual void EnablePcapRadeepInternal (std::string prefix, 
                                       Ptr<Radeep> radeep, 
                                       uint32_t interface,
                                       bool explicitFilename);
  ...
  virtual void EnableAsciiIpv4Internal (Ptr<OutputStreamWrapper> stream, 
    ...
    virtual void EnableAsciiRadeepInternal (Ptr<OutputStreamWrapper> stream, 
                                        std::string prefix, 
                                        Ptr<Radeep> radeep, 
                                        uint32_t interface,
                                        bool explicitFilename);
  ...
  const RadeepRoutingHelper *m_routing;
  ...
  bool PcapHooked (Ptr<Radeep> radeep);
   ...
   * \returns true if a hook is found
   */
  bool AsciiHooked (Ptr<Radeep> radeep);
